                                ...
                                <Grid item xs={12} paddingLeft={1}>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={7} alignItems={'left'} sx={{ marginLeft: 0 }} >
                                                <Typography
                                                    sx={{ fontSize: '17px', textAlign: 'left' }}
                                                    gutterBottom variant="body2">
                                                    {String(selectedRecord.eps_flag)}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
                                    ...
                                    <Box sx={{ p: 1 }}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={5} alignItems={'left'} sx={{ marginLeft: -6 }}>
                                                <Typography
                                                    sx={{ fontSize: '17px', textAlign: 'left' }}
                                                    gutterBottom variant="body2">
                                                    {selectedRecord.apn_context}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
