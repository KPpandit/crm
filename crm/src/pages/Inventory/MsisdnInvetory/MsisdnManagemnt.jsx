...
const MSISDN_manage = (props) => {
    const columns = [
        { id: 'msisdn', name: 'MSISDN'},
        { id: 'category', name: 'Category'},
        { id: 'series_id', name: 'Series-ID'},
        { id: 'is_prepaid', name: 'Prepaid' },
        { id: 'is_postpaid', name: 'Postpaid'},
        { id: 'is_m2m', name: 'M2M'},
    ];
    ...
    const handleConfirmDelete = () => {
        ...
        axios.delete(`http://172.5.10.2:9696/api/msisdn/mgmt/detail/delete/`+recordIdToDelete, {
            headers: {
                Authorization: `Bearer ${tokenValue}`,
                "Accept": "application/json",
                "Content-Type": "application/json"
                            ...
                            <Grid container>
                                <Grid item xs={12} paddingLeft={1}>
                                    ...
                                    <Box sx={{ p: 1 }}>
                                        <Grid container>
                                            <Grid item xs={4}>
                                                <Typography sx={{ fontWeight: '480', fontSize: '17px', textAlign: 'left' }}>  MSISDN :</Typography>
                                            </Grid>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={7} alignItems={'left'} sx={{ marginLeft: 0 }} >
                                                <Typography
                                                    sx={{ fontSize: '17px', textAlign: 'left' }}
                                                    gutterBottom variant="body2">
                                                    {String(selectedRecord.is_prepaid)}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={6} alignItems={'left'} sx={{ marginLeft: 0 }}>
                                                <Typography
                                                    sx={{ fontSize: '17px', textAlign: 'left' }}
                                                    gutterBottom variant="body2">
                                                    {String(selectedRecord.is_postpaid)}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid item xs={7} alignItems={'left'} sx={{ marginLeft: 0 }} >
                                                <Typography
                                                    sx={{ fontSize: '17px', textAlign: 'left' }}
                                                    gutterBottom variant="body2">
                                                    {String(selectedRecord.is_special_no)}
                                                </Typography>
                                            </Grid>
                                        </Grid>
                                    </Box>
                            ...
                            <Grid container spacing={1} padding={1}>
                                <Grid item xs={12}>
                                    <Button variant="contained"
                                        ...
                                        onClick={() => {
                                            navigate('/editmsisdn', { state: { selectObj: selectedRecord } })
                                        }}
                                    >Edit Record</Button>
                                </Grid>
                                <Grid item xs={12}>
