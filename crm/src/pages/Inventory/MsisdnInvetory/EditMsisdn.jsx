...
export default function EditMSISDN(){
    ...
    const tomsisdnmanagement=()=>{
        navigate('/msisdnmanagement')
      }
      ...
      const { handleChange, handleSubmit, handleBlur, values,setValues } = useFormik({
        ...
        onSubmit: async (values) => {
            // console.log(values);
            // setResult(values);
            const res = await axios.put("http://172.5.10.2:9696/api/msisdn/mgmt/detail/edit/"+selectObj.id,
                { ...values }, {
                headers: {
                ...
                if (res.status === 200) {
                    toast.success('Msisdn Record Updated Successfully', { autoClose: 2000 });
    ...
    useEffect(() => {
        if (selectObj) {
            setValues((prevValues) => ({
                ...
                category: selectObj.category || '',
                series_id: selectObj.series_id || '',
                is_prepaid: selectObj.is_prepaid || '',
                is_postpaid: selectObj.is_postpaid || '',
                is_m2m: selectObj.is_m2m || '',
                is_special_no: selectObj.is_special_no || '',
