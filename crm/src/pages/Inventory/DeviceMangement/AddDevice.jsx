...
export default function AddDevice() {
    ...
    const { handleChange, handleSubmit, handleBlur, values } = useFormik({
        ...
        onSubmit: async (values) => {
            // console.log(values);
            // setResult(values);
            const res = await axios.post('http://172.5.10.2:9696/api/device/mgmt/detail/save',
                { ...values }, {
                headers: {
                ...
                if (res.status === 200) {
                    toast.success('Device Record Added Successfully', { autoClose: 2000 });
