        ...
        <>
            <Box sx={{ display: 'container', marginTop: -3 }}>
                <Box sx={{ width: '100%' }}>
                    ...
                    <Box component="main" sx={{ flexGrow: 1, paddingTop: "1%" }} >
                        <Grid container spacing={1} padding={2}>
                            ...
                            <Grid item xs={12} textAlign={'center'}>
                                <FormControl sx={{width:350}}>
                                    ...
                                    >
                                        <MenuItem value="option1">Top up</MenuItem>
                                        <MenuItem value="option2">Pre-Paid</MenuItem>
                                        <MenuItem value="option3">Post-Paid</MenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
